...
_PRECONFIG_PRECLONEDREPOSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='yoshi.synth.preconfig.Preconfig.PreclonedReposEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='yoshi.synth.preconfig.Preconfig.PreclonedReposEntry.value', index=1,
...
_PRECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='precloned_repos', full_name='yoshi.synth.preconfig.Preconfig.precloned_repos', index=0,
...
_PRECONFIG.fields_by_name['precloned_repos'].message_type = _PRECONFIG_PRECLONEDREPOSENTRY
DESCRIPTOR.message_types_by_name['Preconfig'] = _PRECONFIG
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

Preconfig = _reflection.GeneratedProtocolMessageType('Preconfig', (_message.Message,), {

  'PreclonedReposEntry' : _reflection.GeneratedProtocolMessageType('PreclonedReposEntry', (_message.Message,), {
